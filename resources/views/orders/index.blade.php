      ...
      <section>
            <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
                ...
                <div class="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
                    <button type="button" onclick="window.location='{{ route('orders.create') }}'" class="flex items-center justify-center text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800">
            ...
            <h1 class="text-2xl font-bold text-center text-gray-800 dark:text-white mb-4">Laundry Orders</h1>
                    ...
                    <tbody>
                        @foreach ($orders as $order)
                            <tr>
                                ...
                                <td class="px-4 py-3">RM {{ $order->price }}</td>
                                <td class="px-4 py-3">{{ $order->date_taken }}</td>
                                <td class="px-4 py-3">
